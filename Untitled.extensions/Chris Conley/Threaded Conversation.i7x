...
[My custom property to check what we've asked]
A quip can be asked or unasked. A quip is usually unasked.
...
Deciding whether or not there are unasked quips is an activity.

[This should work on a per-scene basis, or globally if quips are not scene-restricted]
To decide whether there are unasked quips:
	Decide on whether or not there are available unasked quips.

Listing peripheral quips is an activity.

Rule for listing peripheral quips (this is the standard listing foobars rule):
...
Rule for listing repeatable quips (this is the standard listing subject changes rule):
...
Before printing the name of a questioning quip while listing plausible quips or listing repeatable quips (this is the prefix-ask rule):
	say "asked " (A).

Before printing the name of an informative quip while listing plausible quips or listing repeatable quips (this is the prefix-say rule):
	say "say " (A).
